...
export function LoginForm() {
  ...
  async function handleSsoSignIn(provider: 'google' | 'microsoft-entra-id') {
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        <button
          ...
          className="flex items-center justify-center gap-3 px-4 py-2.5 bg-surface2 border border-border rounded-lg text-text text-sm font-medium hover:bg-surface hover:border-accent/40 transition-colors disabled:opacity-50"
        >
